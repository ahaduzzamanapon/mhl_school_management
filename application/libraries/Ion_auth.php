...
class Ion_auth
{
    ...
    public function __construct()
    {
        ...
        if ($lang && isset($lang->language)) {
            $this->lang->load('ion_auth', $lang->language);
        } else {
            // Handle the case where $lang is null or language is not set
            // You might want to set a default language or throw an error
            $this->lang->load('ion_auth', 'english'); // Default to English
            log_message('error', 'Language setting not found, defaulting to English.');
        }
