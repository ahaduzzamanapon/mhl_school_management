            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    foreach ($teacherInfo as $row1) {
                        ...
                        $machine = $row1['teacher_machine_id'];
                        $tearch_photo = $row1['teachers_photo'];
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-group last">
                            <label class="control-label col-md-3">Teacher Photo<span class=""> </span></label>
                            <div class="col-md-3">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="assets/uploads/<?php echo $tearch_photo; ?>" alt="">
                                    </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Teacher's Attendance Machine ID <span class="requiredStar"> * </span></label>
                            <div class="col-md-6">
                                <input type="text" name="teacher_machine_id" value="<?php echo $machine ?>" class="form-control" placeholder="Example-1,2,3........" data-validation="required" data-validation-error-msg="Student's Attendance Machine ID is Required">
                            </div>
                        </div>
