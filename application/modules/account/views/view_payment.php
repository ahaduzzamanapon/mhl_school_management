            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption"> Students Invoice List</div>
                        <div class="tools">
                                ...
                                $grand_total=0;
                                 foreach ($invoice as $row) { 
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="index.php/account/invoice_details/<?php echo $row->id; ?>">Invoice-<?php echo $row->id?></a> </td>
