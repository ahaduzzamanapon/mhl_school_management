                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tbody>
                                <?php foreach ($accountUser as $row) { ?>
                                    <tr>
                                        <td>
                                            <?php echo $row['id']; ?>
                                        </td>
                                        <td>
                                            <div class="tableImage">
                                                <img src="assets/uploads/<?php echo $row['account_photo']; ?>" alt="">
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="btn btn-xs green" href="index.php/account/accountUserDetails?id=<?php echo $row['id']; ?>&uid=<?php echo $row['user_id']; ?>&photo=<?php echo $row['account_photo']; ?>"> <i class="fa fa-file-text-o"></i> <?php echo lang('details'); ?> </a>
                                            <?php if($this->common->user_access('teacher_edit_delete',$userId)){ ?>
                                                ...
                                                <a class="btn btn-xs red" href="index.php/account/accountUserDelete?id=<?php echo $row['id']; ?>&uid=<?php echo $row['user_id']; ?>"  onClick="javascript:return confirm('Are you sure you want to delete this User?')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
