                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Type<span class="requiredStar"> * </span></label>
                                <div class="col-md-6">
                                    <select name="category_id" data-validation="required" class="form-control" onchange="accountList(this.value)">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <select id="txtHint" name="accounts_sub_head_id" data-validation="required" class="form-control">
                                        <option value=""> </option>
                                    </select>
                                </div>
                            </div>
...
function accountList(str) {
    // alert('ok');
        ...
        xmlhttp.open("GET", "index.php/account/accout_list?q=" + str, true);
        xmlhttp.send();
    }
