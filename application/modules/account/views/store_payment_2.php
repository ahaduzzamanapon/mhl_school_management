    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title"> Student Store Payment</h3>
                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                          ...
                          <div style="clear:both;"></div>
                             ...
                             <div class="col-md-12" style="margin: 0 auto 50px 30px;">
                                <table width="80%" border="1" id="cartDiv" style="display: none;">
                                   <tr>
                                      <!-- <td>Member Name</td> -->
...
foreach ($items as $key => $value) {      
   $inventory_item .= '<option value="'.$key.'">'.$value.'</option>';
}
?>
<script>
    var divId = 0; 
    $("#addRow").click(function(e) {
        ...
        items+= '<td><select class="" name="item_id[]" id="item_' + divId +'"><?php echo $inventory_item;?></select></td>';
        items+= '<td>12</td>';
        items+= '<td><input name="quantity[]" onchange="quantity_fn(this.value)" id="amount_' + divId +'"></td>';
        items+= '<td><span id="total_' + divId +'"></span></td>';
        items+= '<td> <a href="javascript:void();" class="btn btn-xs red" onclick="removeRow(this)"> <i class="fa fa-minus-circle"></i> Remove </a></td>';
        items+= '</tr>';

        $('#cartDiv tr:last').after(items);
    }); 
          ...
          return $.ajax({
                ...
                success:function(response_data_json) {
                    ...
                    for (var i = 0; i < item['feeItem'].length; i++) {
                        ...
                        items +='<option value="' + id + '-' + iAmount + '-' + title + '">' + title + '-' + pay_type + iAmount + '</option>';
                    }
                    items+='</select> </div>';
