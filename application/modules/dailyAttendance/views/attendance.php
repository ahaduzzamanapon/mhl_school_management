                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        ...
                        foreach ($students as $row) {
                            ...
                            $class_students = $this->db->get('class_students')->row();

                            if(!empty($class_students)){
                                $mashinid=$class_students->stu_machine_id;

                                $this->db->where('proxi_id', $mashinid);
                                $this->db->where('date_time BETWEEN "'.date('Y-m-d 00:00:00').'" AND "'.date('Y-m-d 23:59:59').'"');
                                $machine = $this->db->get('xin_att_machine')->result();
                                if (!empty($machine)) {
                                    $p = 1;
                                    # code...
                                }else{
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" name="action_<?php echo $i; ?>" required>
                                            <option value="P" <?php if($p==1){echo "selected";} ?> ><?php echo lang('att_pre'); ?></option>
                                            <option value="A" <?php if($p==0){echo "selected";} ?> ><?php echo lang('att_absent'); ?></option>
                                        </select> 
                                    </div>
                                    <div class="col-sm-2">
