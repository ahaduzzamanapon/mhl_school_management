...
<?php foreach ($classStudents as $row3) { ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 marginLeftSex">
                                    <div class="radio-list">
                                        <label class="radio-inline">
                                            <input type="radio" name="status" <?php echo $row3['status']=='Enable'?'checked':''; ?> value="Enable">Enable
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="status" <?php echo $row3['status']=='Disable'?'checked':''; ?> value="Disable"> Disable
                                        </label>
                                    </div>
                                </div>
                            </div>
