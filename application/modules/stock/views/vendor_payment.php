    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title"> Vendor Payments</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="portlet box purple margin-bottom-15">
                    <div class="portlet-title">
                        <div class="caption"> Vendor Payment</div>
                        <div class="tools"> <a class="collapse" href="javascript:;">  </a> </div>
                    </div>
                    <div class="portlet-body form">
                        <?php
                        $form_attributs = array('class' => 'form-horizontal', 'role' => 'form');
                        echo form_open('stock/vendor_payment', $form_attributs);
                        ?>
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <div class="input-group date" data-provide="datepicker">
                                        <input type="text" name="pay_date" class="form-control" value="<?php echo date("d-m-Y")?>" data-validation="required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <?php
                                        ...
                                        echo form_dropdown('pay_vendor_id', $vendors, '', $attr);
                                    ?>
                                </div>
                            </div>      
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input  class="form-control" type="text" name="pay_amount" placeholder="" data-validation="required" data-validation-error-msg="Item quantity required">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input  class="form-control" type="text" name="pay_coment" placeholder="">
                                </div>
                            </div>
            ...
            <div class="col-md-7">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption"> Vendor Payment List </div>
                    </div>
