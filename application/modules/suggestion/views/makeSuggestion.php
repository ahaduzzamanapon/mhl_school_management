            ...
            <div class="col-md-12">
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <?php $form_attributs = array('class' => 'form-horizontal', 'role' => 'form','enctype'=>'multipart/form-data');
                        ...
                        ?>
                            <div class="form-body">
                                ...
                                <div class="form-group last">
                                <label class="control-label col-md-3">Suggestion Doc.<span class="requiredStar"> * </span></label>
                                <div class="col-md-9">
