                        ...
                        <div class="form-body">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="fee_type_id" required>
                                            <option class="edit_value" value="<?php echo $row['fee_type_id'];?>"><?php echo $this->common->fee_type_title($row['fee_type_id']);?></option>
                                            <!-- <option value="">Select...</option> -->
                                            <?php foreach ($fee_types as $row2){?>
                                            <option value="<?php echo $row2['id']?>"><?php echo $row2['fee_title']?></option>
                                            <?php }?>
                                        </select>
                                    </div>
                                </div>
