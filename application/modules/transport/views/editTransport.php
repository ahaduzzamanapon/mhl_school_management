                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="startEnd" id="class" class="form-control">
                                            <option value="">---</option>
                                            <?php foreach ($trans_route as $row2) { ?>
                                                <option value="<?php echo $row2['id'];?>" <?php echo $row['start_end']==$row2['id']?'selected':''; ?> ><?php echo $row2['start_end']; ?></option>
                                            <?php } ?>
                                        </select>
                                        </div>
                                    </div>
