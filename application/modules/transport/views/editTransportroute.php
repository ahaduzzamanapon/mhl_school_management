            ...
            <div class="col-md-12 ">
                ...
                <div class="portlet box green ">
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open("transport/transportRouteEdit?id=$id", $form_attributs);
                        ?>
                            <?php foreach ($transport_route as $row) { ?>    
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">Route(Start/End)<span class="requiredStar"> * </span></label>
                                        <div class="col-md-6">
                                            <input  class="form-control" type="text" name="start_end" placeholder="" value="<?php echo $row['start_end']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
