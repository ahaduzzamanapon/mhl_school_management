        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">
                    ...
                    <?php echo lang('acc_ant'); ?> <small></small>
                </h3>
                ...
                <div class="portlet box green ">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            Give The Information For New Account
                    ...
                    <div class="portlet-body form">
                        ...
                        echo form_open_multipart('users/addAccount', $form_attributs);
                        ?>
                        <div class="form-body">
                            <?php
                            if (!empty($success)) {
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        ...
                                        <div>
                                            <span class="btn default btn-file">
                                                <span class="fileinput-new"><?php //echo lang('tea_si'); 
                                                                            ?> Browse Image </span>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Account's Attendance Machine ID</label>
                                <div class="col-md-6">
                                    <input type="text" name="account_machine_id" class="form-control" placeholder="Example-1,2,3........">
                                </div>
                            </div>
