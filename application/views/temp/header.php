...
<body class="page-header-fixed page-quick-sidebar-over-content page-header-fixed-mobile page-footer-fixed1">
    ...
    <div class="page-header navbar navbar-fixed-top">
        ...
        <div class="page-header-inner">
            ...
            <a href="javascript:;" class="menu-toggler responsive-toggler" data-toggle="colzzzzzzlapse" data-target=".navbar-collapse">
            </a>
            ...
            <div class="top-menu">
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                        ...
                        <ul class="dropdown-menu" style="padding: 10px 20px; min-width: 250px;">
                            <li>
                                <p>
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu" style="min-width:190px; padding: 10px 20px;">
                            <li>
    ...
    if ($cont == "home") {
        ...
        if ($view == "addTransport") {
            ...
            $transport = $s . ' ' . $a;
            $allTransport = $a;
        } elseif ($view == "assignTrnsStudent" || $view == "assignTrnsStudentEdit") {
            $transport = $s . ' ' . $a;
            $assignTrnsStudent = $a;
        } elseif ($view == "assignTrnsList") {
            $transport = $s . ' ' . $a;
            $assignTrnsList = $a;
        }
        ...
        if ($view == "add_account_category") {
            ...
            $student_payment = $s . ' ' . $a;
            // $invoice_details = $a;
        } elseif ($view == "DuePayment") {
            $account = $s . ' ' . $a;
            $student_payment = $s . ' ' . $a;
            $DuePayment = $a;
        } elseif ($view == "TransectionHistory") {
            $account = $s . ' ' . $a;
            $student_payment = $s . ' ' . $a;
            $TransectionHistory = $a;
        } elseif ($view == "StorePayment") {
            $account = $s . ' ' . $a;
            $student_payment = $s . ' ' . $a;
            $StorePayment = $a;
        } elseif ($view == "ViewStorePayment") {
            $account = $s . ' ' . $a;
            $student_payment = $s . ' ' . $a;
            $ViewStorePayment = $a;
        } elseif ($view == "transection") {
        ...
        if ($view == "conWeeklyDay") {
            ...
            $configuration = $s . ' ' . $a;
            $messageSettings = $a;
        } elseif ($view == "setFee" || $view == "fee_type_edit" || $view == "delete_fee_type") {
            $configuration = $s . ' ' . $a;
            $accountSetting = $s . ' ' . $a;
            $setFee = $a;
            ...
            $accountSetting = $s . ' ' . $a;
            $employSalary = $a;
        } elseif ($view == "setScholarship" || $view == "scholarshipEdit" || $view == "scholarshipDelete") {
            $configuration = $s . ' ' . $a;
            $accountSetting = $s . ' ' . $a;
            $setScholarship = $a;
        } elseif ($view == "listScholarship" || $view == "scholarshipEdit" || $view == "scholarshipDelete") {
            $configuration = $s . ' ' . $a;
            $accountSetting = $s . ' ' . $a;
            $listScholarship = $a;
        }
        ...
        if ($view == "vendors" || $view == "vendordetails" || $view == "vendoredit" || $view == "deletevendors") {
            ...
            $stock = $s . ' ' . $a;
            $inv_cate = $a;
        } elseif ($view == "inventory_item" || $view == "edit_inv_item" || $view == "delete_inv_item") {
            $stock = $s . ' ' . $a;
            $inv_item = $a;
        } elseif ($view == "purchase_item" || $view == "edit_purchase_item" || $view == "delete_purchase_item") {
            $stock = $s . ' ' . $a;
            $purchase_item = $a;
        } elseif ($view == "vendor_payment") {
            $stock = $s . ' ' . $a;
            $vendor_payment = $a;
    ...
    <div class="page-container">
        <!-- $user = $this->ion_auth->user()->row(); -->
        <!-- BEGIN SIDEBAR -->
        <div class="page-sidebar-wrapper" style="background-color: #1d3844;">
            <div class="page-sidebar navbar-collapse collapse" style="background-color: #1d3844;">
                <!-- BEGIN SIDEBAR MENU -->
                <ul class="page-sidebar-menu" data-auto-scroll="true" data-slide-speed="200">
                    ...
                    <?php if (
                        $this->common->user_access('add_new_class', $userId) ||
                        $this->common->user_access('all_class_info', $userId) ||
                        $this->common->user_access('class_promotion', $userId) ||
                        $this->common->user_access('add_subject', $userId) ||
                        $this->common->user_access('all_subject', $userId) ||
                        $this->common->user_access('assin_optio_sub', $userId) ||
                        $this->common->user_access('add_class_routine', $userId) ||
                        $this->common->user_access('all_class_routine', $userId) ||
                        $this->common->user_access('own_class_routine', $userId) ||
                        $this->common->user_access('add_exam_gread', $userId) ||
                        $this->common->user_access('exam_gread', $userId) ||
                        $this->common->user_access('add_exam_routin', $userId) ||
                        $this->common->user_access('all_exam_routine', $userId) ||
                        $this->common->user_access('take_exam_attend', $userId) ||
                        $this->common->user_access('exam_attend_preview', $userId) ||
                        $this->common->user_access('make_result', $userId) ||
                        $this->common->user_access('approve_result', $userId) ||
                        $this->common->user_access('view_result', $userId) ||
                        $this->common->user_access('all_mark_sheet', $userId) ||
                        $this->common->user_access('own_mark_sheet', $userId) ||
                        $this->common->user_access('make_suggestion', $userId) ||
                        $this->common->user_access('all_suggestion', $userId) ||
                        $this->common->user_access('own_suggestion', $userId) ||
                        $this->common->user_access('creat_notice', $userId)
                    ) { ?>
                        <!-- accademic sidebar -->
                                    ...
                                    <li class="nav-item <?php echo $attendanse; ?>">
                                        ...
                                        <ul class="sub-menu" style="margin-left: 10px;">
                                            <?php //if ($this->common->user_access('take_studence_atten', $userId)) { ?>
                                                ...
                                                <li class="nav-item <?php echo $studentAtten; ?>">
                                                    <a href="index.php/dailyAttendance/attendenceFile" class="nav-link ">
                                                        <span class="title">Attendence file Upload</span>
                                                    </a>
                                                </li>
                                                <!-- <li class="nav-item <?php echo $studentAtten; ?>">
                                                    <a href="index.php/dailyAttendance/attendenceProccess" class="nav-link ">
                                                        <span class="title">Attendence Proccess</span>
                                                    </a>
                                                </li> -->
                                            <?php //}
                    ...
                    if ($this->common->user_access('add_account_title', $userId) || $this->common->user_access('fee_collection', $userId) || $this->common->user_access('all_slips', $userId) || $this->common->user_access('trensection', $userId) || $this->common->user_access('pay_salary', $userId) || $this->common->user_access('own_slip', $userId)) { ?>
                        ...
                        <li class="nav-item <?php echo $account; ?>">
                            ...
                            <ul class="sub-menu">
                                <?php if ($this->common->user_access('add_new_class', $userId)) { ?>
                                    <li class="nav-item <?php echo $addClass; ?>">
                                        <a href="index.php/users/addAccount" class="nav-link ">
                                ...
                                <?php if ($this->common->user_access('add_new_class', $userId)) { ?>
                                    <li class="nav-item <?php echo $addClass; ?>">
                                        <a href="index.php/account/allAccountUser" class="nav-link ">
                                            <span class="title">All Accounts Users</span>
                                        </a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php if ($this->common->user_access('add_account_title', $userId)) { ?>
                                    ...
                                    <li class="nav-item <?php echo $setAaccount_category; ?>">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <?php }
                                            if ($this->common->user_access('add_account_title', $userId)) { ?>
                                ...
                                if ($this->common->user_access('add_account_title', $userId)) { ?>
                                    <li class="nav-item <?php echo $student_payment; ?>">
                                        <a href="javascript:;" class="nav-link nav-toggle">
                                    ...
                                    if ($this->common->user_access('trensection', $userId)) { ?>
                                            <li class="nav-item <?php echo $money_receipt; ?>">
                                    ...
                                    if ($this->common->user_access('pay_salary', $userId)) { ?>
                                            <li class="nav-item <?php echo $ViewPayment; ?>">
                                        ...
                                        <?php }
                                    if ($this->common->user_access('pay_salary', $userId)) { ?>
                                            <li class="nav-item <?php echo $TransectionHistory; ?>">
                                                <a href="index.php/account/TransectionHistory" class="nav-link ">
                                                    <span class="title"> Transection History </span>
                                                </a>
                                            </li>
                                        <?php }
                                    if ($this->common->user_access('pay_salary', $userId)) { ?>
                                            <li class="nav-item <?php echo $DuePayment; ?>">
                                                <a href="index.php/account/DuePayment" class="nav-link ">
                                        ...
                                        <?php }
                                    if ($this->common->user_access('pay_salary', $userId)) { ?>
                                            <li class="nav-item <?php echo $StorePayment; ?>">
                                                <a href="index.php/account/StorePayment" class="nav-link ">
                                                    <span class="title"> Store Payment </span>
                                                </a>
                                            </li>
                                        <?php }
                                    if ($this->common->user_access('pay_salary', $userId)) { ?>
                                            <li class="nav-item <?php echo $StorePayment; ?>">
                                                <a href="index.php/account/ViewStorePayment" class="nav-link ">
                                                    <span class="title"> View Store Payment </span>
                                                </a>
                                            </li>
                    ...
                    if ($this->common->user_access('add_category', $userId) || $this->common->user_access('all_category', $userId) || $this->common->user_access('add_books', $userId) || $this->common->user_access('all_books', $userId) || $this->common->user_access('add_library_mem', $userId) || $this->common->user_access('memb_list', $userId)) { ?>
                        <!-- Library sidebar -->
                        ...
                        <li class="nav-item <?php echo $transport; ?>">
                            ...
                            <ul class="sub-menu">
                                <?php if ($this->common->user_access('add_transport', $userId)) { ?>
                                    <li class="nav-item <?php echo $addTransportroute; ?>">
                                        <a href="index.php/transport/addTransportroute" class="nav-link ">
                                            <span class="title">Route(Start/End)</span>
                                        </a>
                                    </li>
                                ...
                                <?php if ($this->common->user_access('all_transport', $userId)) { ?>
                                    <li class="nav-item <?php echo $assignTrnsStudent; ?>">
                                        <a href="index.php/transport/assignTrnsStudent" class="nav-link ">
                                            <span class="title">Assign To Student</span>
                                        </a>
                                    </li>
                                <?php } ?>

                                <?php if ($this->common->user_access('all_transport', $userId)) { ?>
                                    <li class="nav-item <?php echo $assignTrnsList; ?>">
                                        <a href="index.php/transport/assignTrnsList" class="nav-link ">
                                            <span class="title">Transport Assign List</span>
                                        </a>
                                    </li>
                                <?php } ?>
                            </ul>
                        ...
                        <li class="nav-item <?php echo $stock; ?>">
                            ...
                            <ul class="sub-menu">
                                ...
                                if ($this->common->user_access('inve_item', $userId)) { ?>
                                    <li class="nav-item <?php echo $inventory_item; ?>">
                                        <a href="index.php/stock/inventory_item" class="nav-link">Inventory Item</a>
                                    </li>
                                <?php }
                                if ($this->common->user_access('inve_item', $userId)) { ?>
                                    <li class="nav-item <?php echo $purchase_item; ?>">
                                        <a href="index.php/stock/purchase_item" class="nav-link">Purchase Item</a>
                                    </li>
                                <?php }
                                if ($this->common->user_access('inve_item', $userId)) { ?>
                                    <li class="nav-item <?php echo $vendor_payment; ?>">
                                        <a href="index.php/stock/purchase_item" class="nav-link">Vendor Payment</a>
                                    </li>
                                <?php }
                                if ($this->common->user_access('inve_item', $userId)) { ?>
                                    comment this section
                                    <li class="nav-item <?php echo $inv_item; ?>">
                                        <a href="index.php/stock/inv_item" class="nav-link"><?php //echo lang('header_inve_item'); 
                                                                                            ?> 2</a>
                                    </li>
                                <?php }
                            ...
                            <ul class="sub-menu">
                                ...
                                if ($this->common->user_access('setting_accounts', $userId)) { ?>
                                    <li class="nav-item <?php echo $accountSetting; ?>">
                                        ...
                                        <ul class="sub-menu">
                                            <li class="nav-item <?php echo $setFee; ?>">
                                                <a href="index.php/configuration/setFee" class="nav-link ">
                                                    <span class="title">Setup Fee<?php //echo lang('header_set_stu_fee'); 
                                                                                    ?></span>
                                                </a>
                                            </li>
                                            ...
                                            <li class="nav-item <?php echo $setScholarship; ?>">
                                                <a href="index.php/configuration/setScholarship" class="nav-link ">
                                                    <span class="title">Scholarship Setup<?php //echo lang('header_set_stu_fee'); 
                                                                                            ?></span>
                                                </a>
                                            </li>
                                            <li class="nav-item <?php echo $listScholarship; ?>">
                                                <a href="index.php/configuration/listScholarship" class="nav-link ">
                                                    <span class="title">Scholarship List<?php //echo lang('header_set_stu_fee'); 
                                                                                        ?></span>
                                                </a>
                                            </li>
